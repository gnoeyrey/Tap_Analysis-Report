...
const DEFAULT_QUESTIONS: Record<string, any[]> = {
  '사업성': [
    { id: 'biz_1', label: '비즈니스 확장성(Scalablilty', guide: '① BM 개발 중\n② BM 개발 완료 및 테스트 중\n③ 시장검증단계를 통해 가능성 확인\n④ BM을 통해 시장확보 및 고객 창출 중임\n⑤ BM을 통해 적정한 규모의 매출 발생 중임' },
  ...
  '지식재산권(IP)': [
    { id: 'fin_1', label: '특허 포트폴리오 전략', guide: '① 없음\n② 1개 이상\n③ 3개 이상\n④ 5개 이상\n⑤ 10개 이상' },
